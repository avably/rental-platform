...
export default async function EmbedWidgetPage({ searchParams }: PageProps) {
  ...
  // sklepu, na której stoi ta ramka, a nie do strony gospodarza. Od ADR-191
  // sprzedaż wymaga KOMPLETU dokumentów (regulamin + polityka prywatności):
  // brak któregokolwiek zostawia `terms` puste i widget renderuje blokadę.
    ...
    <EmbedWidget
      ...
      terms={
        legalGateOpen && publishedTerms
          ? {
              /* PERMALINK konkretnej wersji, nie żywy adres (ADR-191). */
