/**
 * Alias angielski regulaminu (B4, decyzja właściciela: kanon polski + aliasy
...
export default function TenantTermsAlias(): never {
  permanentRedirect(LEGAL_DOCUMENT_PATHS.terms);
}
