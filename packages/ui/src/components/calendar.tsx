  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative border border-input rounded-md has-focus:border-foreground has-focus:outline-solid has-focus:outline-[3px] has-focus:outline-offset-2 has-focus:outline-accent dark:has-focus:outline-ring",
